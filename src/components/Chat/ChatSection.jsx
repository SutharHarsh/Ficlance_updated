          ...
          <div className='text-center max-w-md px-6'>
            ...
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              <button
                ...
                className='px-6 py-3 bg-primary text-white rounded-lg hover:bg-primary/90 transition-all duration-200 font-medium shadow-md hover:shadow-lg flex items-center justify-center gap-2 group'
              >
                Go to Dashboard
